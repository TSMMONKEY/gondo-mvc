...
<html lang="en">
  <head>
    ...
    <title>Gondo Skills Institute Security Services</title>
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-GL2HYN47LJ"
    ></script>
    <script>
    ...
    <nav class="navbar navbar-expand-lg bg-light shadow-lg">
      <div class="container">
        <a class="navbar-brand" href="/">
          <img
            src="images/clear-background-logo.svg"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="featured-block d-flex justify-content-center align-items-center">
                                <a href="sign-up.html" class="d-block">
        ...
        <div class="row" style="text-align: center">
          ...
          <div class="col-lg-3 col-md-6 col-12 mt-5">
            <div class="widget">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="/#section_3" style="color: #d9d8d8 !important"
                    >Courses</a
                  >
                </li>
                <li>
          ...
          <div class="col-lg-3 col-md-6 col-12 mt-5">
            ...
            <p class="text-white d-flex mb-2">
              <i
                class="bi-telephone me-2"
                style="color: #d9d8d8 !important"
              ></i>

              <a
                href="tel: (+27) 11-499-4002 / (+27) 11 331 3407"
                class="site-footer-link"
                style="color: #d9d8d8 !important"
              >
                (+27) 11-499-4002 / (+27) 11 331 3407
            ...
            <p
              class="text-white d-flex mt-3"
              style="text-align: left; color: #d9d8d8 !important"
            >
            ...
            <div class="col-lg-12 col-md-12 col-12">
              <p class="copyright-text mb-0" style="text-align: center">
                ...
                <a href="#" target="_blank"
                  >Gondo Skills Institute Security Services</a
                >
              </p>
            </div>
          </div>
